...
class LengthTableTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function dataProviderConvert(): array
    {
        return [
            ...
            [1, Length::INCH, Length::FEET, 0.08333333333333333,],
            ...
            [10, Length::INCH, Length::FEET, 0.8333333333333334,],
            ...
            //from feet
            [1, Length::FEET, Length::INCH, 12,],
            [1, Length::FEET, Length::FEET, 1,],
            [1, Length::FEET, Length::YARD, (1 / 3),],
            [1, Length::FEET, Length::MILE, (1 / 5280),],
            [1, Length::FEET, Length::MILLIMETER, 304.8,],
            [1, Length::FEET, Length::CENTIMETER, 30.48,],
            [1, Length::FEET, Length::METER, 0.3048,],
            [1, Length::FEET, Length::KILOMETER, 1 / 3280.84,],
            [10, Length::FEET, Length::INCH, 120,],
            [10, Length::FEET, Length::FEET, 10,],
            [10, Length::FEET, Length::YARD, (10 / 3),],
            [10, Length::FEET, Length::MILE, (10 / 5280),],
            [10, Length::FEET, Length::MILLIMETER, 3048,],
            [10, Length::FEET, Length::CENTIMETER, 304.8,],
            [10, Length::FEET, Length::METER, 3.048,],
            [10, Length::FEET, Length::KILOMETER, 10 / 3280.84,],
            //from yard
            [1, Length::YARD, Length::INCH, 36,],
            [1, Length::YARD, Length::FEET, 3,],
            ...
            [1, Length::MILE, Length::FEET, 5280,],
            ...
            [10, Length::MILE, Length::FEET, 52800,],
            ...
            [1, Length::MILLIMETER, Length::FEET, (1 / 304.8),],
            ...
            [10, Length::MILLIMETER, Length::FEET, (10 / 304.8),],
            ...
            [1, Length::CENTIMETER, Length::FEET, (1 / 30.48),],
            ...
            [10, Length::CENTIMETER, Length::FEET, (10 / 30.48),],
            ...
            [1, Length::METER, Length::FEET, 3.280839895,],
            ...
            [10, Length::METER, Length::FEET, (10 * 3.280839895),],
            ...
            [1, Length::KILOMETER, Length::FEET, 3280.84,],
            ...
            [10, Length::KILOMETER, Length::FEET, 32808.4,],
